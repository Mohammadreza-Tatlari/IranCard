...
export default function Navbar() {
  ...
  return (
    <nav className="block z-50 bg-black text-white border-gray-200 dark:bg-black dark:border-black mb-2">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-around max-md:justify-between mx-auto p-4">
        ...
        >
          <ul className="flex flex-col md:items-center font-medium p-4 md:p-0 mt-4 rounded-sm bg-black md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-black border-black">
            ...
            <li className="md:py-3 px-4 bg-slate-200 text-black rounded-lg hover:bg-gray-700 hover:text-white transition">
              <a
                onClick={toggleLogin}
                href="#"
                className="block py-2 pl-3 pr-4 p-5 md:hover:bg-transparent md:border-0 md:p-0 md:w-auto focus:text-white "
              >
                Login
              </a>
            </li>
