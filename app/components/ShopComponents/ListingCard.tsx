...
export default function ListingCard({
  ...
  return (
    <>
      <div
        className="col-span-1 cursor-pointer group bg-gradient-to-t from-[#1f2a3d] to-[#112242] text-white hover:shadow-white shadow-lg hover:to-white hover:text-white p-3 rounded-lg transition"
        onClick={() => {
          if (userExist) {
      ...
      >
        <div className="flex flex-col gap-2 w-full">
          ...
          <div className="  font-semibold">
            <span
              className={`${
                discount.isDiscounted ? `line-through text-gray-400` : ``
              }`}
            >
              {price}
            </span>{" "}
